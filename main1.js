  window.onload = function(){
    ...
    function myClick (event) {
      console.log(event.map.mapPoint.x + ", " + event.mapPoint.y);
    }
    ...
    require([
          ...
          view.on("click", function(event){
            ...
            let dy = event.mapPoint.longitude - 0.2127;
            let distance = Math.sqrt(((event.mapPoint.longitude - 0.2127) * (event.mapPoint.longitude - 0.2127)) + ((event.mapPoint.latitude - 51.8734) * (event.mapPoint.latitude - 51.8734)))
            console.log(distance < 0.03);
          });
